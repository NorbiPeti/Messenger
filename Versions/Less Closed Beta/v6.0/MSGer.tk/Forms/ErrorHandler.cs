...
namespace MSGer.tk
{
    ...
    { //2015.06.04.
        ...
        //public const int ErrorMessageCount = 10;
        public ErrorHandler(ErrorType type, Exception e)
        {
            ...
            switch (type)
            {
                case ErrorType.Unknown:
                    ...
                    try
                    {
                        //string id = Enum.GetNames(typeof(Language.StringID)).Single(entry => entry == "Error_Unknown" + index + 1);
                        ...
                        {
                            //textBox1.Text = "Unknown error.\n\rAlso...\n\rSomething interesting happened. I don't have all messages up to the latest message count. Which means I forgot to do something.";
