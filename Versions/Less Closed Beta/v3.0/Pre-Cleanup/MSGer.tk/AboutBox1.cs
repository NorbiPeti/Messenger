...
namespace MSGer.tk
{
    partial class AboutBox1 : Form
    {
        ...
        {
            InitializeComponent();
            this.Text = String.Format(Language.Translate("about"), AssemblyTitle);
            this.labelProductName.Text = AssemblyProduct;
            this.labelVersion.Text = String.Format(Language.Translate("about_version"), AssemblyVersion);
            ...
            desc.Add(Language.Translate("about_programmer")); //2014.04.18.
            desc.Add("SzNP");
            desc.Add("http://sznp.tk");
            desc.Add("");
            desc.Add(Language.Translate("about_specialthanks"));
            desc.Add("Jonathan Kay");
            desc.Add("http://messengergeek.com");
            desc.Add(Language.Translate("about_specthanks1"));
            desc.Add("");
            desc.Add(Language.Translate("about_specthanks2"));
            desc.Add("");
            desc.Add("Allen Anderson");
            desc.Add("http://www.codeproject.com/Articles/4012/C-List-View-v");
            desc.Add(Language.Translate("about_specthanks3"));
            desc.Add("");
