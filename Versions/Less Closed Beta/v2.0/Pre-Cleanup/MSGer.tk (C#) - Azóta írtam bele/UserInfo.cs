        ...
        public string Name
        {
            ...
            set
            {
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    ...
                    { //ChatForm
#if THREAD_SET_VAR
                        new ThreadSetVar(ChatForm.ChatWindows[list[i]].partnerName, value, ThreadSetVar.UpdateMode_SetText);
#endif
                    }
                }
            }
        ...
        public string Message
        {
            ...
            set
            {
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    ...
                    { //ChatForm
#if THREAD_SET_VAR
                        new ThreadSetVar(ChatForm.ChatWindows[list[i]].partnerMsg, value, ThreadSetVar.UpdateMode_SetText);
#endif
                    }
                }
            }
...
#if THREAD_SET_VAR
                        new ThreadSetVar(ChatForm.ChatWindows[list[i]].statusLabel, tmp, ThreadSetVar.UpdateMode_SetText);
#endif
                    }
                }
            }
