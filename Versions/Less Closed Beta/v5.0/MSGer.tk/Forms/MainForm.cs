...
namespace MSGer.tk
{
    public partial class MainForm : ThemedForms
    {
        ...
        public MainForm()
        {
            ...
            azonnaliÜzenetKüldéseToolStripMenuItem.Text = Language.Translate(Language.StringID.Menu_Operations_Sendmsg);
            Language.ReloadEvent += delegate { azonnaliÜzenetKüldéseToolStripMenuItem.Text = Language.Translate(Language.StringID.Menu_Operations_Sendmsg); };
            ...
            hangulatjelekToolStripMenuItem.Text = Language.Translate(Language.StringID.Menu_Tools_Emoticons);
            Language.ReloadEvent += delegate { hangulatjelekToolStripMenuItem.Text = Language.Translate(Language.StringID.Menu_Tools_Emoticons); };
        ...
        private void LoadMenu(MenuType mt)
        {
            switch(mt) //2014.12.13.
            {
                ...
                case MenuType.PartnerMenu:
                    listPartnerMenu.Items.Add(Language.Translate(Language.StringID.Menu_Operations_Sendmsg), null, PartnerMenu_SendMessage);
                    listPartnerMenu.Items[listPartnerMenu.Items.Count-1].Name="menu_operations_sendmsg"; //2014.12.22.
                    Language.ReloadEvent += delegate { listPartnerMenu.Items["menu_operations_sendmsg"].Text = Language.Translate(Language.StringID.Menu_Operations_Sendmsg); }; //2014.12.22.
