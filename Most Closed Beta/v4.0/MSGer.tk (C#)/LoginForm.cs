...
namespace MSGer.tk
{
    public partial class LoginForm : Form
    {
        ...
        public void LoginUser()
        {
            ...
            try //Ha itt áll meg, hibát irhat
            {
            ...
            else
            {
                ...
                //Bejelentkezés
                UserInfo.UserID = Convert.ToInt32(responseString);
                LoginForm.UserCode = CalculateMD5Hash(CalculateMD5Hash(PassText).ToLower() + " Some text because why not " + UserInfo.UserID).ToLower();
                Closeable = true;
                this.Invoke(new MyDelegate(SetLoginValues));
            }
        }
