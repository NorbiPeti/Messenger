...
namespace MSGer.tk
{
    ...
    { //2014.12.21.
        ...
        public void ThemedForms_Load(object sender, EventArgs e)
        {
            ...
            {
                PrepControl(control); //TODO: Controls.ControlAdded-nél is az új control-ra alkalmazza
                if (control is ToolStrip)
                    Theme.SetRenderer((ToolStrip)control); //2015.07.05.
                foreach (Control ctrl in control.GetAll())
                { //2015.07.03.
                    PrepControl(ctrl);
                }
                ...
                {
                    Theme.SetRenderer(toolstrip); //2015.07.05.
                }
            }
        }
        private void PrepControl(Control control)
        { //2015.07.03.
            Theme.SkinControl(control);
            control.Click += control_Click;
        }

        public static ThemeDesigner ThemeDesignerRunning; //2015.07.03.
        void control_Click(object sender, EventArgs e)
        {
            if (ThemeDesignerRunning != null)
            { //2015.07.03.
                ThemeDesignerRunning.SelectedType = sender.GetType();
            }
        }
