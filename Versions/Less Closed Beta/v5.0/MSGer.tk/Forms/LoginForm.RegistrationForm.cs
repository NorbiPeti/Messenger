...
namespace MSGer.tk
{
    public partial class LoginForm_RegistrationForm : ThemedForms
    {
        public LoginForm_RegistrationForm()
        {
            ...
            label3.Text = Language.Translate(Language.StringID.Reg_UserName);
            label4.Text = Language.Translate(Language.StringID.Login_Password);
        ...
        private void registerButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(Language.Translate(Language.StringID.Unknown_Error) + ":\n" + response);
                registerButton.Enabled = true;
            }
        }
    }
