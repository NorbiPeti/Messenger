...
namespace MSGer.tk
{
    public partial class MainForm : Form
    {
        ...
        private void LogoutUser(object sender, EventArgs e)
        {
            ...
            //UserInfo.Partners = new List<UserInfo>();
            UserInfo.Partners.Clear();
        ...
        public void UpdatePartnerList()
        {
            while (PartnerListThreadActive && MainThread.IsAlive)
            {
                 ...
                 * 2014.03.21. - Array -> List
                 * Most már nem szabad megtörténnie
                }*/
                try
        ...
        private void OpenSendMessage(object sender, EventArgs e) //2014.03.02. 0:17
        {
            ...
            /*if (UserInfo.Partners[RightClickedPartner].ChatWindow.MultiChat == null && (UserInfo.Partners[RightClickedPartner].ChatWindow == null || UserInfo.Partners[RightClickedPartner].ChatWindow.IsDisposed))
                UserInfo.Partners[RightClickedPartner].ChatWindow = new ChatForm();
            //A MultiChat-hoz nem nyúlunk, ezáltal sima beszélgetés lesz
            UserInfo.Partners[RightClickedPartner].ChatWindow.ChatPartner = RightClickedPartner;
            ...
            RightClickedPartner = -1; // A form bezárásakor állitsa vissza - Inkább ne; Azóta átalakitottam
        }
