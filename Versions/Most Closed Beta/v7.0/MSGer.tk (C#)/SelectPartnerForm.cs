    ...
    public partial class SelectPartnerForm : Form
    {
        ...
        private void okbtn_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < partners.Length; i++)
            {
                ...
                {
                    if (UserInfo.Partners[j].Name == partners[i] || UserInfo.Partners[j].Email == partners[i] || UserInfo.Partners[j].UserID == Int32.Parse(partners[i]))
                    { //Egyezik a név, E-mail vagy ID
